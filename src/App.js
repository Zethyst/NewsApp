    ...
    return (
      <>
        <BrowserRouter>
          ...
          <Routes>
            <Route exact path="/NewsApp-Frontend" element={<News setProgress={this.setProgress} key="general" apiKey={this.apikey} pageSize={9} country="in" category="general" query={this.state.searchQuery} />} />
